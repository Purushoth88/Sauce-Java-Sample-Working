...
public class PremierQCchooselangTest implements SauceOnDemandSessionIdProvider {
    ...
    public void setUp() throws Exception {
        DesiredCapabilities caps = DesiredCapabilities.chrome();
            caps.setCapability("name", "PremierQCchooselangTest");
    ...
    @Test
    public void PremierQCchooselangTest() {
        ...
        wd.findElement(By.id("ah-aux-choose-language-aria-label")).click();
        wd.findElement(By.linkText("Spanish - español")).click();
        if (!wd.findElement(By.tagName("html")).getText().contains("Salud y seguros")) {
            System.out.println("verifyTextPresent failed");
        }
        wd.findElement(By.linkText("Salud y seguros")).click();
        try { Thread.sleep(4000l); } catch (Exception e) { throw new RuntimeException(e); }
        if (!wd.findElement(By.tagName("html")).getText().contains("Cobertura de beneficios")) {
            System.out.println("verifyTextPresent failed");
        }
        if (!wd.findElement(By.tagName("html")).getText().contains("Escoge un idioma")) {
            System.out.println("verifyTextPresent failed");
        }
        wd.findElement(By.xpath("//div[@class='ah-page-wrapper']/div[2]")).click();
        wd.findElement(By.xpath("//div[@id='ah-header']/div[1]")).click();
        wd.findElement(By.id("ah-aux-choose-language-aria-label")).click();
        wd.findElement(By.linkText("inglés - English")).click();
