...
/*    public static String username = System.getenv("SAUCE_USERNAME");
    ...
    protected static String deviceOrientation;
	...
	public SauceRunner(String os, String version, String browser, String deviceName, String deviceOrientation) {
        super();
        this.os = os;
     ...
     */
    @Before
    public static RemoteWebDriver sauceCapabilities() throws Exception {
